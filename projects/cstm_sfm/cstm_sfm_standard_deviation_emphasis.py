"""Static figure for emphasizing the standard deviation used as a metric.
...
For this figure, only the 1-sigma circle of the reference distribution
centered at \\hat{t}X_1 is highlighted in purple.

Its color, stroke width, and opacity are matched to the previously chosen
purple standard-deviation tangent styling.
"""
...
# match the previously fixed purple tangent styling.
...
def make_comparison_distribution(
    *,
    ...
    The geometry and auxiliary contours are identical between the two
...
class CSTMSFMStandardDeviationEmphasisFigure(
    LightScene
):
    """Highlight the reference standard deviation in purple."""
    ...
    def construct(self) -> None:
        ...
        #
        # The purple 1-sigma circle matches the strong purple
        # tangent styling:
        #   color   = #7B2CBF
        #   width   = 1.75
        #   opacity = 0.84
        ...
        #
        # Same sigma as the reference distribution.
        # Its 1-sigma circle remains faint blue.
        # --------------------------------------------------------
