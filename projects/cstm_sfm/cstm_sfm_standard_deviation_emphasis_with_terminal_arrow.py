...
is strongly highlighted in purple.
...
class CSTMSFMStandardDeviationEmphasisWithTerminalArrowFigure(
    LightScene
):
    """Highlight standard deviation and terminal-time optimization."""
